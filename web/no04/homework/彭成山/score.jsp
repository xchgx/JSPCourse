...
？
		...
		<style type="text/css">
			...
			#main{
				...
				padding: 10px;/*内部填充*/
                                box-shadow: 4px 4px 4px rgba(10,10,10,0.5);
				}
			.title{
				...
				/**font-family: "microsoft yahei";微软雅黑*/
                                text-shadow: 3px 2px 1px rgba(10,10,10,0.7);
			}
			.body{
	...
	<body>
		...
		<div id="main"><!--最外层的div-->
			...
			<div class="body">
				...
				<!-- div.readme -->
			    <div class="readme red">说明<br>此系统查询的信息是已经考试过的成绩，未参加考试的不显示出来</div>
			</div>
		</div>
	</body>
</html>
