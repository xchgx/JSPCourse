...
<%
  request.setCharacterEncoding("UTF-8");//设置请求的对象为UTF-8
  ...
  for (int i = 0; i < xhs.length; i++) {//遍历数组
      ...
      if(s.equals(xh) && xm.equals(m)){//如果数组中某个元素和学号对等
      //表示输入的学号正确
...
if(finded == false){//如果没有找到，说明输入错误
    ...
    findXh = xh;//如果没有找到学号，就把页面传递过来的学号，作为我们的内容
    findXm = "未找到（无此数据）";//
...
<html>
    <head>
		...
		<style type="text/css">
			...
			#main{
				...
				padding: 10px;/*内部填充*/
                                box-shadow: 4px 4px 4px rgba(10,10,10,0.5);/*盒子阴影*/
				}
			.title{
				...
				/**font-family: "microsoft yahei";微软雅黑*/
                                ...
                                text-shadow: 3px 2px 1px rgba(10,10,10,0.7);/*右边0px，下边1px，模糊1px，灰色*/
			}
			.body{
	...
	<div id="main"><!--最外层的div-->
	    ...
	    <!-- div.readme -->
            <div class="readme red">说明<br>此系统查询的信息是已经考试过的成绩，未参加考试的不显示出来
            <a href="score.jsp">点击返回，继续查询</a></div>
	    </div>
	</div>
    </body>
</html>
